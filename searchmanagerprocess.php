        ...
        <h2>All manager:</h2><br>
                <table id='mtable'>
                        ...
                        try{
                            ...
                            $sqlquerystring="SELECT Manager_id,Name,email,Dept_id,'phone no'
                                            FROM department
                                            WHERE (Name LIKE '%$name%') AND
                                                    CompanyRepresentative_id = (
                            ...
                            if($returnobj->rowCount()==0){
                                ...
                                foreach($tabledata AS $row){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="button" value="Update" onclick="updatem()"><br>
                    ...
                    <input type="button" value="Go Home" onclick="goback()";>
                </form>   
                <script>
                    function updatem(){
                        location.assign('updatemanager.php');
                    }
